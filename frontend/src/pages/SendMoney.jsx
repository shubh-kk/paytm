...
export const SendMoney = () => {
    ...
    const handleSend = async () => {
        try {
            ...
            setTransferResponse({ msg: "Transfer failed, Insufficient balance!!" });
        }
    }
            ...
            >
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        {transferResponse.msg && <div className="mt-4 text-center text-sm font-medium text-red-500">{transferResponse.msg}</div>}
                    </div>
                </div>
            </div>
        </div>
